...
def compile_shaders():
    vertex_shader_source = """
        ...
        void main(void) {
            gl_Position = P_matrix * V_matrix * M_matrix * (position + vec4(gl_InstanceID % 10 + rand(vec2(position.x + gl_InstanceID, gl_InstanceID)), floor(gl_InstanceID / 10.0) , 0.0, 0.0));
